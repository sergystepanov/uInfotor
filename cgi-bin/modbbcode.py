...
def bbcode2html(intext):
    Dictag = {'IMG': ('<img align="%s" alt="" src="%s', '">'),
              'SIZE': ('<span style="font-size: %spx; line-height: normal;">', '[/size]'),
              ...
              'CODE': (
              '''<div class="c-wrap"><div class="c-head"><b>Код %s:</b></div><div class="c-body">''', '</div></div>'),
              'QUOTE': (
              '<div class="q-wrap"><div class="q-head"><span><b>%s</b></span></div><div class="q">', '</div></div>'),
              'QPOST': ('', ''),
